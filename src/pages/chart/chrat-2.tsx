...
export const Chart2: React.FunctionComponent<ChindProps> = ({ data, ...restProps }) => {
    ...
    const getChart = (currentAreas: Array<AreaInfo>) => {
        myChart.current.setOption(
            createEchartsOptions({
                ...
                series: [
                    {
                        type: "bar",
                        data: _.map(currentAreas, it => it.suspectedCount),
                    },
                ],
            })
        );
